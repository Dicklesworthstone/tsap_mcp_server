...
"""
Semantic Search Demo Script (ToolAPI Client Version)

This script demonstrates the semantic search capabilities of TSAP
by interacting with the ToolAPI server via the ToolAPIClient.
"""
...
async def run_semantic_search_demo(query: str, data_dir: str):
    """Run the semantic search demo using ToolAPIClient."""
    console.print(Panel.fit(
        "[bold blue]TSAP Semantic Search Demo (ToolAPI Client)[/bold blue]",
    ...
    # Run search via ToolAPI Client
    print_section("Running Semantic Search via ToolAPI")
...
async def main():
    ...
    parser = argparse.ArgumentParser(description="Run TSAP Semantic Search Demo using ToolAPI Client.")
    parser.add_argument(
        "--query",
        type=str,
