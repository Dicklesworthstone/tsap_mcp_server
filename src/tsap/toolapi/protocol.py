"""
ToolAPI protocol implementation.
...
class ToolAPICommandType(str, Enum):
    """Types of ToolAPI commands."""
...
class ToolAPIError(BaseModel):
    """Error information for ToolAPI responses."""
...
class ToolAPIResponse(BaseModel):
    ...
    error: Optional[ToolAPIError] = Field(None, description="Error information if status is 'error'")
...
class ToolAPICommandResult(BaseModel):
...
def create_success_response(
    ...
    """Create a successful ToolAPI response.
    ...
    Returns:
        ToolAPIResponse with success status
    """
    return ToolAPIResponse(
...
def create_error_response(
    ...
    """Create an error ToolAPI response.
    ...
    Returns:
        ToolAPIResponse with error status
    """
    return ToolAPIResponse(
        request_id=request_id,
        status="error",
